    ...
    >
      <div className="mb-4 sm:mb-6 flex justify-center">
        <div className="w-20 h-20 sm:w-24 sm:h-24 bg-[#F5F5F5] rounded-full flex items-center justify-center">
          <Heart size={40} className="sm:w-12 sm:h-12 text-[#777777]" />
        </div>
      </div>
      ...
      <p className="text-sm sm:text-base text-[#777777] mb-6 sm:mb-8 max-w-xl mx-auto">
        Запазете любимите си артикули тук, за да ги намирате по-лесно.
      </p>
